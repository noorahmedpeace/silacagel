...
export const seoLandingPages = {
  ...
  "silica-gel-supplier-islamabad": {
    ...
    heroImage: {
      src: "/products/white-nonindicating-clean-sachets.webp",
      alt: "White silica gel sachets for pharmaceutical and electronics packing in Islamabad and Rawalpindi",
  ...
  "silica-gel-supplier-multan": {
    ...
    heroImage: {
      ...
      alt: "Silica gel sachets for dried fruit, date and textile export cartons from Multan",
  ...
  "silica-gel-supplier-gujranwala": {
    ...
    heroImage: {
      src: "/products/industrial-dry-clay-desiccant-packs.webp",
      alt: "Clay and silica gel desiccant packs for Gujranwala engineering export cartons",
  ...
  "silica-gel-supplier-peshawar": {
    ...
    heroImage: {
      src: "/products/premium-bulk-supply.webp",
      alt: "Bulk silica gel and carton packs for Peshawar dry fruit and furniture trade",
  ...
  "silica-gel-supplier-hyderabad": {
    ...
    heroImage: {
      src: "/products/format-bulk-beads.webp",
      alt: "Silica gel beads and packs for Hyderabad and Kotri textile and agri packing",
