...
export const exportMarkets: ExportMarket[] = [
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g carton packs", "1kg-5kg container strips", "Private-label cartons"],
  ...
  },
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g bags", "Container strips", "Sample packs before bulk orders"],
    documents: ["ISO 9001:2015", "SDS", "COA", "DMF-free statement"],
    routeNote:
    ...
    faqs: [
      { question: "What is the MOQ for silica gel to Qatar?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g bags", "25kg loose bulk", "Private-label sachet/carton programs"],
    documents: ["ISO 9001:2015", "SDS", "COA", "DMF-free statement"],
    routeNote:
  ...
  },
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g carton packs", "25kg loose bulk", "1kg-5kg cargo strips"],
    documents: ["ISO 9001:2015", "SDS", "COA", "DMF-free statement"],
    routeNote:
    ...
    faqs: [
      { question: "What is the MOQ for silica gel to Vietnam?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    faqs: [
      { question: "What is the MOQ for silica gel to Russia?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g carton packs", "Private-label sachets", "1kg-5kg cargo strips"],
    documents: ["ISO 9001:2015", "SDS", "COA", "DMF-free statement"],
    routeNote:
    ...
    faqs: [
      { question: "What is the MOQ for silica gel to Bangladesh?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g packs", "25kg loose bulk", "Container desiccant strips"],
    documents: ["ISO 9001:2015", "SDS", "COA", "DMF-free statement"],
    routeNote:
    ...
    faqs: [
      { question: "What is the MOQ for silica gel to Indonesia?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    products: ["0.5g-20g silica gel sachets", "25g-500g carton packs", "25kg loose bulk beads", "Container desiccant strips"],
    documents: ["ISO 9001:2015", "SDS", "COA", "DMF-free statement"],
    routeNote:
    ...
    faqs: [
      {
        ...
        answer:
          "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis.",
      },
      {
  ...
  },
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g packs", "Bulk beads", "Container strips"],
    documents: ["ISO 9001:2015", "SDS", "COA", "DMF-free statement"],
    routeNote:
    ...
    faqs: [
      { question: "What is the MOQ for silica gel to Turkey?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g packs", "25kg loose bulk", "Private-label sachets"],
    documents: ["ISO 9001:2015", "SDS", "COA", "DMF-free statement"],
    routeNote:
    ...
    faqs: [
      ...
      { question: "What is the MOQ for silica gel to India?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    faqs: [
      { question: "What is the MOQ for silica gel to Brazil?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g bags", "25kg loose bulk", "Container strips"],
    documents: ["ISO 9001:2015", "SDS", "COA", "DMF-free statement"],
    routeNote:
    ...
    faqs: [
      { question: "What is the MOQ for silica gel to Malaysia?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g carton packs", "Bulk silica gel", "Private-label sachets"],
    documents: ["ISO 9001:2015", "SDS", "COA", "DMF-free statement"],
    routeNote:
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "What is the MOQ on FOB Karachi terms?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g carton packs", "1kg-5kg container strips", "Dry clay desiccant packs"],
    documents: ["ISO 9001:2015", "SDS", "COA", "DMF-free statement"],
    routeNote:
    ...
    faqs: [
      { question: "What is the MOQ for silica gel to the UK?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g carton packs", "1kg-5kg cargo strips", "Dry clay desiccant for industrial parts"],
    documents: ["ISO 9001:2015", "SDS", "COA", "DMF-free statement"],
    routeNote:
    ...
    faqs: [
      { question: "What is the MOQ for silica gel to Germany?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g carton packs", "1kg-5kg cargo strips", "Dry clay desiccant packs"],
    documents: ["ISO 9001:2015", "SDS", "COA", "DMF-free statement"],
    routeNote:
    ...
    faqs: [
      { question: "What is the MOQ for silica gel to Canada?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g packs", "1kg-5kg cargo strips", "Dry clay desiccant packs"],
    documents: ["ISO 9001:2015", "SDS", "COA", "DMF-free statement"],
    routeNote:
    ...
    faqs: [
      { question: "What is the MOQ for silica gel to Australia?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "What is the MOQ for silica gel to France?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    products: ["0.5g-20g sachets", "25g-500g carton packs", "25kg loose bead bags", "1kg-5kg container strips", "Dry clay desiccant packs"],
    ...
    faqs: [
      ...
      { question: "What is the MOQ for silica gel to Africa?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "What is the MOQ for silica gel to Europe?", answer: "There is no minimum order quantity. Every format, from 0.5 g sachets to 5 kg container strips, can be supplied as a trial or sample quantity first, and the per-unit rate improves as volume grows. Send the format, quantity, and destination and the quote comes back on that basis." },
