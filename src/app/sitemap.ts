...
// The export-desk byline is used by zero articles and reads as a second copy
// of the company story; it stays live (media-kit links it) but noindexed.
const AUTHOR_SLUGS = ["noor-ahmed-khan"] as const;
